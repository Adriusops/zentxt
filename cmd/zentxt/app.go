...
func (a *App) ExportVersion(versionID, filePath string) error {
	version, err := versioning.GetVersion(a.db, versionID)
	if err != nil {
		return err
	}
	return os.WriteFile(filePath, []byte(version.Content), 0644)
}
